...
<template>
  ...
  >
    ...
    <!-- 工作流管理弹窗 (SaaS Style) -->
    <Dialog
      v-model:visible="isWorkflowListVisible"
      modal
      :style="{ width: '640px' }"
...
.n8n-popup-menu .p-menuitem-link {
...
.n8n-modern-dialog .p-dialog-header {
  border-bottom: 1px solid #f1f4f8;
  padding: 1rem 1.5rem;
}
.n8n-modern-dialog .p-dialog-header-title {
  font-weight: 800;
  font-size: 16px;
  color: #1a1f36;
}
.n8n-modern-dialog .p-dialog-content {
  padding: 0 1rem;
}
